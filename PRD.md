...
|---|---|
| Core relational SQL | MySQL, PostgreSQL, SQLite, Oracle, SQL Server, and SAP HANA should provide query execution, metadata discovery, result browsing, completion, pagination, and staged mutations when row identity and transaction semantics are available. |
