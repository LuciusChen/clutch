...
> Superseded by [postmortem 184](184-explicit-result-padding-under-horizontal-scroll.md). `min-width` aligned stationary grids but did not preserve alignment when horizontal scrolling started inside a cell.
