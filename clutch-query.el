...
Saved entries include discovered connections (e.g. `.hana.gpg') via
`clutch--all-connection-entries', with static `clutch-connection-alist'
names winning on collision."
  (let (matched-buffers)
    (append
     (cl-loop for (name . _) in (clutch--all-connection-entries)
