...
| PostgreSQL | Core SQL support | Requires [pgsql.el](https://github.com/LuciusChen/pgsql.el) |
...
| `:backend pg` | [pgsql.el](https://github.com/LuciusChen/pgsql.el) |
...
- Install current [pgsql.el](https://github.com/LuciusChen/pgsql.el) separately for `:backend pg`.
