...
- **Public naming**: `clutch-` for the clutch package. External protocol packages keep their own public namespaces, including `mysql-`, `pgsql-`, `mongodb-`, and `redis-`. No double dash for public API.
